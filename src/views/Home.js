...
const Home = (props) => {
    ...
    await axios({
      ...
      .then(async (response) => {
        ...
        if (response.data.status == 1) {
          console.log("response is in home screen", response.data);
  ...
  const online_status = async (status) => {
    setLoading(true);
    console.log("global.currency", global.currency);
    await axios({
      method: "post",
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={{ padding: 10 }} showsVerticalScrollIndicator={false}>
        ...
        >
          ...
          <View
            onPress={move_profile.bind(this)}
            style={{
              width: "50%",
              justifyContent: "center",
              alignItems: "flex-end",
          ...
          >
            ...
            >
              <Image
                ...
                source={{ uri: img_url + props.vendor_profile_picture }}
              />
            </TouchableOpacity>
          </View>
        </View>
        ...
        <Text
          style={{ fontSize: 16, fontFamily: bold, color: colors.theme_fg_two }}
        >
          Your Reports
        </Text>
        <View style={{ margin: 5 }} />
